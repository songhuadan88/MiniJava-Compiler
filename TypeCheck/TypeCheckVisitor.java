...
public class TypeCheckVisitor extends GJDepthFirst<VariableType ,SymbolInterface> {
	...
	String errorInfo="";
	 ...
	 /**
	   ...
	   public VariableType visit(MainClass n, SymbolInterface argu) {
	      VariableType _ret=null;
	      SymbolTable symbolTable=(SymbolTable)argu;
	      n.f0.accept(this, argu);
	      n.f1.accept(this, argu);
	      n.f2.accept(this, argu);
	      ...
	      n.f14.accept(this, symbolTable.mainClassItem.functionItem);
	      n.f15.accept(this, symbolTable.mainClassItem.functionItem);
	   ...
	   public VariableType visit(ClassDeclaration n, SymbolInterface argu) {
	      ...
	      n.f1.accept(this, argu);
	      n.f2.accept(this, argu);
	      ClassItem classItem=symbolTable.SearchClass(n.f1.f0.toString());
	   ...
	   public VariableType visit(MethodDeclaration n, SymbolInterface argu) {
	      ...
	      n.f8.accept(this, functionItem);
	      n.f9.accept(this, argu);
	      VariableType retType= n.f10.accept(this, functionItem);
	      if(!VariableType.IsA(retType,functionItem.retType,classItem.parentTable))
	      {
	    	  AddError("Return value does not match return type at line "+n.f9.beginLine);
	      }
	      n.f11.accept(this, argu);
	      n.f12.accept(this, argu);
	      return _ret;
	...
	/**
	   ...
	   public VariableType visit(PrimaryExpression n, SymbolInterface argu) {
	      ...
	      if(n.f0.choice instanceof Identifier)
	      {
	    	  ...
	    	  VariableItem variableItem= functionItem.SearchVariable(identifier.f0.toString());
	    	  if(variableItem!=null)
	    		  return variableItem.type;
	    	  ClassItem classItem=functionItem.parentClass;
	    	  variableItem=classItem.SearchVariable(identifier.f0.toString());
	    	  if(variableItem!=null)
	    		  return variableItem.type;
	   ...
	   public VariableType visit(ThisExpression n, SymbolInterface argu) {
	      ...
	      FunctionItem functionItem=(FunctionItem)argu;
	      n.f0.accept(this, argu);
	      return new VariableType(FourType.Object,functionItem.parentClass.name);
	   }
	   ...
	   public VariableType visit(AllocationExpression n, SymbolInterface argu) {
	      ...
	      n.f2.accept(this, argu);
	      n.f3.accept(this, argu);
	      return new VariableType(FourType.Object,n.f1.f0.toString());
	   }
